  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      textTheme: TextTheme(
        ...
        headlineSmall: TextStyle(fontSize: 20, color: AppColors.neutral900),
        bodyLarge: TextStyle(fontSize: 16, color: AppColors.neutral800),
        bodyMedium: TextStyle(fontSize: 14, color: AppColors.neutral800),
        bodySmall: TextStyle(fontSize: 12, color: AppColors.neutral800),
      ),
  ...
  static ThemeData get darkTheme {
    return ThemeData(
      ...
      textTheme: TextTheme(
        ...
        headlineSmall: TextStyle(fontSize: 20, color: AppColors.neutral100),
        bodyLarge: TextStyle(fontSize: 16, color: AppColors.neutral200),
        bodyMedium: TextStyle(fontSize: 14, color: AppColors.neutral200),
